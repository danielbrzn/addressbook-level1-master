...
public class AddressBook {
    ...
    /*
        Details of a person for use as keys in the person HashMap
     */
    ...
    private static String executeAddPerson(String commandArgs) {
        ...
        person.put(PERSON_PROPERTY_NAME, personToAdd[PERSON_DATA_INDEX_NAME]);
        person.put(PERSON_PROPERTY_PHONE, personToAdd[PERSON_DATA_INDEX_PHONE]);
        person.put(PERSON_PROPERTY_EMAIL, personToAdd[PERSON_DATA_INDEX_EMAIL]);
